...
const newProduct = () => {
        ...
        <div className="flex flex-row px-6 bg-white w-full h-full">
          ...
          <div className="bg-white w-[25%] ml-3 mt-3 border-gray-300 border p-2 rounded-lg">
            <div>
              ...
              <div className="mt-5">
                <p className="text-lg text-blue-950 font-black">
                Enter Pincode To Check Best Price
                </p>
                <div className="flex mt-2">
                  <input
                    type="text"
              ...
              <button className="mt-2 bg-blue-950 text-white w-full flex items-center justify-center gap-2 border p-2 rounded">
                {/* <Heart className="text-red-500" /> Wishlist */} Add to Cart
              </button>
  ...
  <thead>
    <tr className="bg-green-400 bg-opacity-55">
      <th className="text-left py-2 px-4">Select</th>
      <th className="text-left py-2 px-4">Quantity</th>
      <th className="text-left py-2 px-4">Discounted Price</th>
    </tr>
  </thead>
  <tbody>
    {bulkDiscounts.map((discount, index) => (
        ...
        <td className="py-2 px-4">
          <div className="flex items-center justify-center">
            <input
              type="radio"
              name="bulkSelect"
              className="w-5 h-5 text-green-600 border-gray-300 focus:ring-2 focus:ring-green-400"
            />
          </div>
        </td>
        <td className="py-2 px-4">{discount.qty}</td>
      ...
      <p>
        <span className="text-black font-black">Import From: China</span> 
      </p>
      <div className="flex items-start space-x-2 mt-2">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">(89.7% within 30 Days)</p>
        </div>
      </div>
      <div className="flex items-start space-x-2 mt-2">
