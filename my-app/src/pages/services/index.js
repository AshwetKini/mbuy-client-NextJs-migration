...
function Service () {
  ...
  if (loading) {
    return (
      <>
        <Head>
          <title>Material Buy Services</title>
          <meta
            name="description"
            content="Discover services like interior design, modular kitchen, roofing shingles & more services at Materialbuy.com. Quality solutions for your construction and home needs."
          />
        </Head>
        <Layout>
        <Fullcontainer className={Styles.fullcontainer}>
          <Container className={`w-full ${Styles.container}`}>
            <TabNavigation />
            <div
              role="status"
  ...
  const handleCardClick = (id) => {
    navigation.push(`/servicedetails/${id}`);
  };
  return (
    <>
      <Head>
